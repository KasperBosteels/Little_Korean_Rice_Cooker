...
var response =await [firstPage(prefix),MakeEmbed(general,prefix),MakeEmbed(fun,prefix),MakeEmbed(music,prefix),MakeEmbed(moderating,prefix),MakeEmbed(debug,prefix)];

//dm the response string to the author if not possible send in channel
try {
    ReactionPages(message,response,textPageChange,emojis,time);
}catch(error){
