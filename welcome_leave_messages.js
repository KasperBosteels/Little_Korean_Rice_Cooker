...
module.exports = {
	execute(con) {
		var data;
        con.query('SELECT guildID,enabled,welcomeMessage,leaveMessage FROM welcome_leave_messages;',(err,rows)=>{
    ...
    CONFIRM(guildID){
        let value;
        let rawData =fs.readFileSync('./jsonFiles/welcome_leave_messages.json','utf-8');
